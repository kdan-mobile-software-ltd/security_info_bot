...
def test_fixture_mode_skips_smtp(tmp_path, monkeypatch):
    ...
    ok = email_mod.send_internal_announcement(
        [{"情資內容": "fixture-test", "相關性": "高相關"}], dry_run=False
    )
